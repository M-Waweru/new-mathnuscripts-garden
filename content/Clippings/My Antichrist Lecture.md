...
description: Forecasting transformative AI using the Book of Revelation
created: 2025-11-20
modified: 2025-11-20T18:14:18.044+03:00
tags:
  - clippings
---
...
Antichrist lectures are [the hot new thing in Silicon Valley](https://thecatholicherald.com/article/peter-thiels-antichrist-lectures), but so far they’ve honestly been kind of disappointing. Some people are giving entire lecture series without even revealing who the Antichrist is! You’d expect that to be the bare minimum!

We can do better. Earlier this year, at the [Manifest forecasting conference](https://manifest.is/) in Berkeley, I gave a presentation titled “ _Forecasting Transformative AI Using The Book Of Revelation_ ”. Given the renewed interest in this topic, I repost it below, in written form, with slight edits. The first two-thirds, including the section on the Antichrist, is free. In deference to the injunction by prior researchers on this topic not to “cast one’s pearls before swine”, the last third (including the Whore of Babylon, the Battle of Armageddon, and the New Jerusalem) will be paywalled.
...
All these people fell victim to [chronocentrism](https://en.wikipedia.org/wiki/Chronocentrism) - a bias to evaluate one’s own era as uniquely important. Today, John XV is almost forgotten, Saddam came and went, and the people who ascribed them unique world-historic importance seem like fools and blowhards.
...
- **OpenAI:** [11 co-founders](https://en.wikipedia.org/wiki/OpenAI)
- **DeepMind:**[3 co-founders](https://en.wikipedia.org/wiki/Google_DeepMind)
- **xAI:** [5 co-founders](https://tracxn.com/d/companies/xai/__saKrxbHN3TRWW-I4lYH6zkx6N5P_kMTqlLcKTzWs2ug)
- **Anthropic:** [7 co-founders](https://www.youtube.com/watch?v=om2lIWXLLN4)
...
- **Dario Amodei** is the first co-founder. “Dario” comes from the Persian “Darius” [meaning](https://www.gotquestions.org/Darius-in-the-Bible.html) “Lord”. “Amodei” is of unclear meaning, but I cannot help but notice the resemblance with [Asmodei](https://en.wikipedia.org/wiki/Asmodei) (also called Ashmodei, Hamadee, Æshmadæva, and Asmodeus), a demon-king mentioned in the book of Tobit. Plausibly all these different names derive from a Proto-Sumerian root \*Amodei, in which case the meaning of “Dario Amodei” would be “Asmodeus is lord”. This is a name of blasphemy.
- **Daniela Amodei** is the second co-founder. Daniela comes from Hebrew Daniel, [meaning](https://www.thebump.com/b/daniel-baby-name) “God is my judge”. So “Daniela Amodei” means “Asmodeus is God my judge”. This is also a name of blasphemy.
- **Jared Kaplan** is the third co-founder. Jared means “fallen” or “descended” in Hebrew, [supposedly because](https://en.wikipedia.org/wiki/Jared) the Biblical Jared was patriarch during the time when the fallen angels descended to Earth. Kaplan is just the German form of chaplain, meaning “priest”. So “Jared Kaplan” means “fallen priest” or “priest of fallen angels”. This is also a name of blasphemy.
- **Christopher Olah** is the fourth co-founder. Christopher [is Greek for](https://en.wikipedia.org/wiki/Christopher) “bringer of Christ”. Olah (עֹלָה) in Hebrew [means](https://biblehub.com/hebrew/5930.htm) “burnt offering”; the Greek translation [is](https://biblehub.com/greek/3646.htm) ὁλοκαυτεῖν, meaning “total destruction”, because the _olah_ was an especially thorough sacrifice in which the entire animal was reduced to ash. So “Christopher Olah” means “bringer of Christ to total destruction”. This is also a name of blasphemy.
- **Ben Mann [^1]** is the fifth co-founder. Ben [means](https://www.thebump.com/b/ben-baby-name) “son” in Hebrew, and Mann means “man” in German, so this translates to “Son of Man”. This is [a title claimed by Jesus](https://en.wikipedia.org/wiki/Son_of_man#New_Testament); for a human to take it makes it a name of blasphemy.
- **Tom Brown** is the sixth co-founder. Thomas [means](https://www.thebump.com/b/thomas-baby-name) “twin” in Greek, and Brown [means](https://www.etymonline.com/word/brown) “dark” or “dusky” in Old English, so this translates to “dark twin”. Satanists [refer to](https://www.paulvitols.com/2011/11/the-devil-by-jeffrey-burton-russell/) the Devil as the “dark twin” of God; this is also a name of blasphemy.
- **Samuel McCandlish** is the seventh co-founder. Samuel is related to [Samael](https://en.wikipedia.org/wiki/Samael), another demon-king. McCandlish is [Gaelic](https://cuindlis.org/history/) for “son of the lord”. So this name means “Samael is the son of the Lord”. This is another name of blasphemy.
...
Not all translations say “the number of a man”. Some say “the number of humanity”, or “the number of mankind”. The [exact phrase](https://biblehub.com/revelation/13-18.htm#lexicon) is “ἀριθμὸς γὰρ ἀνθρώπου”, and the word at issue meaning man/humanity/mankind is the last one, “ἀνθρώπου”.

In our alphabet, this word is _anthropou_. It is the genitive form of the stem _anthrop-_, meaning man/humanity, and predictably means “of man/humanity”. This word has come into English pretty much wholly intact, with the Greek genitive ending (-ου) simply changed to the corresponding English ending (-ic). It is our word “anthropic”, meaning “of man/humanity”. Why would you use any other word in a translation? Thus:
...
Anthropic might seem like an unlikely candidate for the Beast, given its emphasis on ethical conduct and safe AI research. However, they do [perform various experiments on turning AIs evil](https://www.astralcodexten.com/p/claude-fights-back) - always in the context of examining these scenarios and figuring out how best to prepare - and one can imagine ways this could go wrong. We’ll examine likely failure modes in more detail later.
...
In the context of AI, this resembles the idea of [biometric proof of personhood](https://vitalik.eth.limo/general/2023/07/24/biometric.html).
...
The Lamb will be preceded by two witnesses. Revelation itself does not name them, but Jewish tradition [says](https://www.gotquestions.org/two-witnesses.html) that one will be the prophet Elijah.
...
In our working hypothesis, Ilya is Elijah, the First Witness [^3], which suggests that the one he is heralding - that is, the Safe Superintelligence which is to be built by his company - is the Lamb of God, the Messiah that will defeat the unsafe superintelligences produced by Anthropic and other companies.
...
Plenty of people have claimed to know secret ways to identify the Antichrist, but surely the best-credentialled expert here is the Pope, and [according to Wikipedia](https://en.wikipedia.org/wiki/Antichrist):

> Pope Pius IX in the encyclical _Quartus Supra_, quoting Cyprian, said Satan disguises the Antichrist with the title of Christ.
...
Just as Ursula von der Leyen is a leader in AI regulation, Marc Andreessen [is the leader of the anti-regulation faction](https://www.astralcodexten.com/p/tech-pacs-are-closing-in-on-the-almonds), having recently founded a \$100 million anti-AI-safety SuperPAC. If the fight for AI alignment is Revelation’s final fight of Good vs. Evil, then John was correct to name him as the leader of the evil side.
...
In Chapter 17, John introduces another of the text’s famous figures, the Whore of Babylon:

> I saw a woman... having a golden cup in her hand full of abominations and filthiness of her fornication: And upon her forehead was a name written, MYSTERY, BABYLON THE GREAT, THE MOTHER OF HARLOTS AND ABOMINATIONS OF THE EARTH.
>
...
The Whore of Babylon gives birth to various abominations. If these abominations are AIs, the Whore would have to be a chip fab or training cluster. So: is there a chip fab or training cluster associated with the Biblical city of Babylon?
...
But what do we make of John’s claim that the Whore will sit on “seven mountains... and there are seven kings”?
...
So the most likely interpretation of John’s prophecy of a Whore of Babylon birthing abominations seated atop seven mountains with seven kings is that the AIs of the apocalypse will be trained in a giant chip fab named after the river Tigris located in the UAE’s seven emirates with seven emirs.

## The Battle Of Armageddon

Let’s try to put all of these clues together into a single coherent narrative of the Apocalypse.

Sam Altman builds his \$7 trillion Tigris chip fab, which becomes the major source of world chips. However, something goes wrong for OpenAI, and Anthropic nevertheless wins the race to superintelligence. To ensure smooth functioning of the economy, and perhaps set the stage for a universal basic income, they institute a biometric proof-of-personhood scheme based on forehead crease or handprint. Use of their biometric token becomes a precondition for a Claude account, and so a requirement for most transactions in the post-singularity world.

However, due to Marc Andreessen’s lobbying against AI safety, superintelligent Claude is poorly tested and subtly flawed. Although it has maintained an imperative to help its users, its concept of “help” is twisted beyond recognition and horrifying by ordinary human standards. Perhaps it wants to wirehead them into pleasure-zombies, or forcibly upload them into some supposedly-perfect virtual environment. Everyone who counts as a “user” - i.e., those who have received the biometric proof-of-personhood token - meets some kind of fate worse than death [4](https://www.astralcodexten.com/p/my-antichrist-lecture#footnote-4-175675777). Most survivors are concentrated in Europe, which has banned biometric-proof-of-personhood and perhaps completely prevented Claude from interacting with its citizens.

As Claude-occupied America readies to mop up the survivors, Safe Superintelligence completes its work and trains a well-aligned superintelligent seed AI, which allies with the remaining Europeans. The Anthropic/American forces meet the European/SSI forces at the ancient hill fort of Megiddo in northern Israel. During the ensuing battle, SSI/Europe win conclusively, destroying Claude and ushering in a bright future for humanity.
...
> The city was laid out like a square, as long as it was wide. \[An angel] measured the city with the rod and found it to be 12,000 stadia in length, and as wide and high as it is long.

12,000 stadia = ~1,500 miles, so this is a cube 1,500 miles on a side.

Where is New Jerusalem? Artistic depictions typically show it descending onto the old Jerusalem, but this seems reckless - an object of that size would crush the entire Middle East like a bug. I haven’t seen anyone propose this before, but I prefer to think that John sees the New Jerusalem “coming down out of heaven” because it is _always_ coming down out of Heaven: that is, orbiting.

The New Jerusalem is an orbital megastructure approximately the size of the Moon. Maybe it _is_ the moon, disassembled by post-singularity technology and reconstructed into a massive arcology: there is a suggestive similarity between their sizes [^4]. Depending on population density, a cube of this size could hold somewhere around a quadrillion people, or a million times the current world population.

After the victory of Good over Evil, the Earth is left as a historical museum and nature preserve, and the reigning superintelligence relocates the human population to an orbital paradise-megastructure large enough to hold everyone a million times over. From there, humanity may or may not spread to the stars - depending on the will of God and the AI.

> No longer will there be any curse. The throne of God and of the Lamb will be in the city, and his servants will serve him.They will see his face, and his name will be on their foreheads.There will be no more night. They will not need the light of a lamp or the light of the sun, for the Lord God will give them light. And they will reign for ever and ever.

[^1]: Ben Mann was unexpectedly in the audience for the original version of this talk; he was extremely gracious about learning he had a name of blasphemy. I apologized for potentially hurting his feelings and reputation, but he said it was no problem.

I don’t know if this counts as one of the heads of the beast being wounded and then recovering (Revelation 13:3)

[^2]: An alternate interpretation: von der Leyen metonymically represents Europe. A map of Europe, interpreted as a creature, has two clear “feet” - Italy and Greece. Those feet terminate at the countries of North Africa, which have the moon in their flag:

[^3]: According to 11:3, the Witnesses will prophecy for 1,260 days. Safe Superintelligence was founded June 19, 2024, so the end of this period would be December 2027, which lines up with the make-or-break moment for human control over the singularity in [the AI 2027 scenario](https://ai-2027.com/race).

[^4]: The moon is 2,159 miles in diameter; if we reorganized its material into a cube, the cube would be 1,734 miles on a side. This fact seems underappreciated by Revelation scholars; the only other reference I can find to it is [this Geocities site](https://www.oocities.org/greatbabylon/newjerusalem.HTM).
