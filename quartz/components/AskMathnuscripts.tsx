  ...
  return (
    <>
      ...
      <script>{`(() => {
        ...
        drawer.querySelector('.ask-mathnuscripts-form').addEventListener('submit', (event) => {
          event.preventDefault()
          if (!input.value.trim()) { input.focus(); return }
          status.hidden = false
          status.textContent = 'This is the UX preview. The live ChatGPT connection and grounded answer endpoint will be wired in the next pilot slice.'
        })
      })()`}</script>
    </>
  )
